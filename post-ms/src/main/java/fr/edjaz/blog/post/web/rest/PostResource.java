...
public class PostResource {
    ...
    @GetMapping(value = "/author/{id}/posts/page")
    Page<PostDTO> getAllPostsByAuthorPage(@PathVariable("id") String id, Pageable pageable){
        return postService.getAllPostsByAuthorPage(id,pageable);
    }
}
