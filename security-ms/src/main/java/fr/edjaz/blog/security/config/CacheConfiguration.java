package fr.edjaz.blog.security.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("security");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("security");
        ...
        config.getMapConfigs().put("fr.edjaz.blog.security.domain.*", initializeDomainMapConfig(jHipsterProperties));
