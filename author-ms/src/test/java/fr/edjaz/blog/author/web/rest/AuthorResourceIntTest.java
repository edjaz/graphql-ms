package fr.edjaz.blog.author.web.rest;

import fr.edjaz.blog.author.AuthorApp;

import fr.edjaz.blog.author.config.SecurityBeanOverrideConfiguration;
...
import fr.edjaz.blog.author.web.rest.errors.ExceptionTranslator;
...
import static fr.edjaz.blog.author.web.rest.TestUtil.createFormattingConversionService;
...
@SpringBootTest(classes = {AuthorApp.class, SecurityBeanOverrideConfiguration.class})
public class AuthorResourceIntTest {
    ...
    public void createAuthor() throws Exception {
        ...
        assertThat(testAuthor.getIdUser()).isEqualTo(DEFAULT_ID_USER);
    }
    ...
    public void updateAuthor() throws Exception {
        ...
        assertThat(testAuthor.getIdUser()).isEqualTo(UPDATED_ID_USER);
    }
